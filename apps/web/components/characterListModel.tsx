        ...
        <div className="border-0 rounded-lg bg-slate-800 py-2 px-3 hover:bg-slate-950">
          ...
          <div className="flex gap-2">
            <div className="text-xs">
              ...
              <span className="text-slate-100">{character.level ? character.level : '1'}</span>
            </div>
            <div className="text-xs">
              <span className="text-slate-400">Background: </span>
              <span className="text-slate-100">{character.background}</span>
            </div>
            {character.origin && (
              <div className="text-xs">
                <span className="text-slate-400">Origin: </span>
                <span className="text-slate-100">{character.origin}</span>
              </div>
            )}
          </div>
        </div>
